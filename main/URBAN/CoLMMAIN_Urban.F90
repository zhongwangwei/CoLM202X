...
!-------------------------- Local Variables ----------------------------
   ...
   ! Placeholder outputs required by the LEAF_interception_CoLM2014
   ! signature in this codebase. URBAN uses original CoLM2014 behavior;
   ! the routine returns 0 for all of these on the CoLM2014 path, so they
