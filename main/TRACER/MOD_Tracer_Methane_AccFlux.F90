...
CONTAINS
   ...
   SUBROUTINE flush_methane_acc_fluxes ()
      ...
      ! optional microbial-pool diagnostics
      a_B_methanogen             (:,:) = 0._r8
      a_B_methanotroph           (:,:) = 0._r8
      a_B_methanogen_dormant     (:,:) = 0._r8
      a_B_methanotroph_dormant   (:,:) = 0._r8
      a_f_T_methanogen           (:,:) = 0._r8
      a_f_S_methanogen           (:,:) = 0._r8
      a_f_O2_methanogen          (:,:) = 0._r8
      a_f_T_methanotroph         (:,:) = 0._r8
      a_methanogen_growth_rate   (:,:) = 0._r8
      a_methanotroph_growth_rate (:,:) = 0._r8
      a_microbial_prod_potential (:,:) = 0._r8
      a_microbial_oxid_potential (:,:) = 0._r8
      ...
      a_methane_acc_num_microbe (:) = 0._r8
   ...
   SUBROUTINE accumulate_methane_fluxes ()
      ...
      CALL acc_count1d (totcol_methane, a_methane_acc_num)
      ...
      CALL acc_count1d (totcol_methane_unsat, a_methane_acc_num_unsat)
      CALL acc_count1d (totcol_methane_sat,   a_methane_acc_num_sat)
      ...
      CALL acc_count1d (totcol_methane_lake, a_methane_acc_num_lake)
