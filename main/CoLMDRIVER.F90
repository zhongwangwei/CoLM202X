...
!=======================================================================
   ...
   USE MOD_Tracer_Methane_Coupler, only: tracer_methane_resolve_step, &
      tracer_methane_lake_step, tracer_methane_wetland_decomp, &
      tracer_methane_soil_step, tracer_methane_report
#endif
#ifdef HYPERSPECTRAL
...
! ======================================================================
...
#if (defined TRACER) && (defined BGC)
      CALL tracer_methane_resolve_step (istep_in, istep_local)
#endif
...
#if (defined TRACER) && (defined BGC)
               CALL tracer_methane_lake_step (istep_local, i, idate, deltim_phy, k, steps_in_one_deltim)
#endif
...
#if (defined TRACER) && (defined BGC)
         CALL tracer_methane_wetland_decomp (i)
#endif

#if (defined TRACER) && (defined BGC)
         CALL tracer_methane_soil_step (istep_local, i, idate, deltim)
#endif
#endif
      ...
      ! Surface tracer balance report is routed through TRACER so CH4
      ! diagnostics stay behind the methane registry gate.
#if (defined TRACER) && (defined BGC)
      CALL tracer_methane_report ()
#endif
